...
- **npm packaging scaffolding** (`npm/`), built and **deliberately not published**.
  A wrapper package with one payload package per platform, selected through
  `optionalDependencies`, so there is no postinstall: it works offline, behind a
  proxy, and under `--ignore-scripts`. Publishing is deferred — `npm/README.md`
...
[Unreleased]: https://github.com/pokt-network/pocket-ap/compare/v0.1.2...HEAD
[0.1.2]: https://github.com/pokt-network/pocket-ap/compare/v0.1.1...v0.1.2
